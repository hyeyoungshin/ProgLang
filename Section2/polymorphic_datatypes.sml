...
careful: now shadowig the built in ones! *)
datatype 'a option = NONE | SOME of 'a

(* similary, here are polymorphic lists but without special syntax *)
datatype 'a mylist = Empty | Cons of 'a * 'a mylist

(* a fancier example for binary trees where internal nodes have data of any 1 type and leaves have data of another possibly-different type *)
datatype ('a,'b) tree = Npde of 'a * ('a,'b) tree * ('a,'b) tree
		      | Leaf of 'b
